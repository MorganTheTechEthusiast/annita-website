  ...
  return (
    <section className="py-20 px-10 md:px-20 bg-gray-100 dark:bg-black/20">
      <div className="container mx-auto text-center">
        <h2 className="text-6xl dark:text-gray-300 md:text-8xl text-left font-bold mb-14">
          Endless payment <br /> possibilities <br />{" "}
          <span className="text-vibrant-orange">for enterprises</span>
        </h2>
        <div className="flex gap-2 justify-center items-center col-span-1 md:col-span-3">
          {/* Service 1 */}
