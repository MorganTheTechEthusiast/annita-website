    ...
    return (
      <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 bg-white">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0">
          <h2 className="text-5xl font-bold leading-tight text-vibrant-orange mb-100">Contact Our <br /> Sales team</h2>
          ...
          <p className="text-lg text-gray-700 mt-4">
            Please complete the form on the right to connect with a member of our team.
          </p>
        </div>
        ...
        <div className="md:w-1/2 w-full bg-gray-100 p-6 rounded-lg shadow-md mt-10">
          <form className="grid grid-cols-1 gap-4">
            ...
            <input type="text" name="website"  className="w-full p-3 border rounded-lg" />
          <select name="employees" required className="w-full p-3 border rounded-lg">
            <option value="">Number of employees</option>
            <option value="1-10">1-10</option>
            <option value="11-50">11-50</option>
            <option value="51-200">51-200</option>
          </select>
          <select name="volume" required className="w-full p-3 border rounded-lg">
          ...
          <select name="industry" required className="w-full p-3 border rounded-lg">
            <option value="">Industry</option>
            <option value="Tech">Tech</option>
            <option value="Finance">Finance</option>
            <option value="Healthcare">Healthcare</option>
          </select>
          <select name="solution" required className="w-full p-3 border rounded-lg">
            <option value="">What specific solution are you interested in?</option>
            <option value="Marketing">Marketing</option>
            <option value="Consulting">Consulting</option>
          </select>
            <button type="submit" className="bg-black text-vibrant-orange p-3 rounded-md font-medium hover:opacity-80">
              Submit
            </button>
          </form>
        </div>
