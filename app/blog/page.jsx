  ...
  return (
    <section className="py-20 px-5 md:px-20 bg-gray-100 dark:bg-black">
      <div className="container mx-auto text-left">
        <div className="flex items-center gap-6 justify-between mb-28 mt-14">
          <div>
            <h1 className="text-4xl md:text-8xl font-bold text-gray-800 dark:text-white mb-8 ">
              Welcome to <span className="text-vibrant-orange">Annita</span>{" "}
              Blog
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Uncover a treasure trove of insights, practical tips, and
              inspiring stories designed to empower you on your journey through
